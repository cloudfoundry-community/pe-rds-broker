...
// MySQLEngine client holder
type MySQLEngine struct {
	logger lager.Logger
	db     *sql.DB
}

// NewMySQLEngine factory
...
// ExistsDB checks if DB is already created
...
// CreateDB create DB on MySQL instance
...
// Privileges grant privileges to user
